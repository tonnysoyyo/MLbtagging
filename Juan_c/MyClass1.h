...
// Mon Jul 22 15:04:12 2024 by ROOT version 6.30/06
// from TChain Delphes/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxTrack = 125;
   static constexpr Int_t kMaxTower = 247;
   static constexpr Int_t kMaxEFlowTrack = 125;
   static constexpr Int_t kMaxEFlowPhoton = 63;
   static constexpr Int_t kMaxEFlowNeutralHadron = 167;
   static constexpr Int_t kMaxGenJet = 6;
...
#ifdef MyClass1_cxx
MyClass1::MyClass1(TTree *tree) : fChain(0) 
{
